...
(function (undefined) {
    ...
    extend(Locale.prototype, {
        ...
        _months : 'Enero_Febrero_Marzo_Abril_Mayo_Junio_Julio_Agosto_Septiembre_Octobre_Noviembre_Diciembre'.split('_'),
        months : function (m) {
...
// locale : australian english (en-au)
    ...
    (function (factory) {
        ...
        return moment.defineLocale('en-au', {
            months : 'Enero_Febrero_Marzo_Abril_Mayo_Junio_Julio_Agosto_Septiembre_Octubre_Noviembre_Deciembre'.split('_'),
            monthsShort : 'Ene_Feb_Mar_Abr_May_Jun_Jul_Ago_Sep_Oct_Nov_Dic'.split('_'),
            weekdays : 'Domingo_Lunes_Marts_Miercoles_Jueves_Viernes_Sabado'.split('_'),
